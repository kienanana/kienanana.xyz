...
- bon retour — welcome back / safe return  
...
- je suis en forme — in good shape  
- je suis triste — sad  
...
# Professions
See [[Occupations]] for gender patterns
...
- un agenda — diary  
- un ballon — ball  
- un bloc de papier — pad of paper  
- un bureau — desk  
- un cahier — notebook  
...
- une brosse à dent — toothbrush
- un dentifrice — toothpaste 
- une trousse de toilette — toiletries bag 
...
# Prepositions
See [[Basic Prepositions]] · [[Les Directions]] for directions
...
# Frequency
See [[Adverbes de fréquence]] for usage rules
...
# Quantities
See [[Expressions de quantité]] for containers and approximations
...
- une tablette de — a bar of (e.g. chocolate)
- une boîte de — a box / tin of  
- un carton de — a carton of  
...
# Transport
See [[L9]] for preposition rules (en vs à)

### en (sheltered / enclosed)
- le bus — bus
- le tram — tram
- le métro — metro
- le train — train
...
- le vélo — bicycle
- la moto — motorbike
- la trottinette / la mobylette — scooter
- à pied — on foot
...
- propre — clean
- sale — dirty
- envie — desire / craving (avoir envie de)
- besoin — need (avoir besoin de)
