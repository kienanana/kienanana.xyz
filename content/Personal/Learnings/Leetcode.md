...
I'm not gonna be as strict about the daily streak thing, but I am going to attempt to complete the entirety of the [Neetcode 150 List](https://leetcode.com/problem-list/plakya4j/) over the coming summer. If I do accomplish that, I think I'll be in a much better spot as an internship candidate, and also just much more confident in my teeny tiny brain's capabilities. 
...
![[Screenshot 2026-05-05 at 9.59.14 PM.png]]
...
#### Update (20/08/26)
I have found that trying to blast through the list in order has not proven very helpful for my pattern recognition and long-term learning. Instead, I will separate the questions into their topics, and clear them topic-by-topic instead.
